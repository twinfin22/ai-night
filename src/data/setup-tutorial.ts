  ...
  steps: [
      ...
      screenshots: [
        {
          ...
          caption: 'Claude 앱 메뉴 화면. 숫자에 마우스를 올리면 설명이 보입니다.',
          captionUrl: 'https://claude.com/ko/download',
          hotspots: [
            {
              label: '1',
    ...
    },
    {
      ...
      screenshots: [
        {
          ...
          caption: 'Codex 작업 폴더 선택 화면. 숫자에 마우스를 올리면 설명이 보입니다.',
          captionUrl: 'https://chatgpt.com/ko-KR/codex/get-started/',
          hotspots: [
            {
              label: '1',
              title: 'Choose project',
              body: '이미 만든 작업 공간을 다시 열 때 씁니다. 처음 수업 폴더를 고를 때는 아래 New project 흐름을 봅니다.',
              x: 12,
              y: 73,
              placement: 'right',
            },
            {
              label: '2',
              title: 'New project',
              body: '새 작업 폴더를 연결할 때 누릅니다. 오늘은 문서/ai-yahak-studio 폴더를 연결합니다.',
              x: 13,
              y: 62,
              placement: 'right',
            },
            {
              ...
              body: '이미 만든 폴더를 Codex 작업실로 쓰는 선택입니다. 수업에서는 이 버튼이 핵심입니다.',
              x: 48,
              y: 72,
              placement: 'right',
            },
            {
              label: '4',
              title: '질문 입력칸',
              body: '여기에 부탁을 씁니다. 큰 작업은 “/goal 수업 폴더를 정리하고 README까지 만들어줘”처럼 시작할 수 있습니다.',
              x: 66,
              y: 59,
              placement: 'top',
            },
            {
              label: '5',
              title: '모델과 생각 깊이',
              body: '처음에는 기본값으로 둡니다. 작업이 어렵거나 오래 걸릴 때만 바꿉니다.',
              x: 82,
              y: 60,
              placement: 'top',
            },
            {
              label: '6',
              title: '보내기',
              body: '부탁을 보냅니다. 보내기 전에 폴더가 맞는지 한 번 더 봅니다.',
              x: 94,
              y: 60,
              placement: 'left',
            },
        ...
        },
        {
          ...
          caption: 'Codex 앱 사이드바 메뉴. 숫자에 마우스를 올리면 설명이 보입니다.',
      ...
      conceptToggles: [
        ...
        {
          title: '/goal',
          body: 'Codex에게 오래 걸리는 목표를 맡길 때 쓰는 명령입니다. 예: “/goal 수업 폴더를 만들고 README와 AGENTS.md까지 완성해줘”. 목표가 켜져 있으면 Codex가 중간에 멈추지 않고 끝났는지 확인하며 진행합니다.',
        },
        {
          title: '결과 확인',
      ...
      screenshots: [
        {
          ...
          caption: 'Claude 입력창과 파일 첨부 위치. 숫자에 마우스를 올리면 설명이 보입니다.',
          captionUrl: 'https://claude.com/ko/download',
          hotspots: [
            {
              label: '1',
              title: '입력창',
              body: '오늘 부탁할 내용을 쓰는 곳입니다. 길게 쓰기보다 지금 필요한 일 하나만 씁니다.',
              x: 30,
              y: 20,
              placement: 'bottom',
            },
            {
              label: '2',
              title: '파일 첨부',
              body: '파일을 붙여서 보여줄 때 씁니다. 개인정보가 들어간 파일은 먼저 가립니다.',
              x: 6,
              y: 56,
              placement: 'right',
            },
            {
              label: '3',
              title: '프로젝트 또는 폴더에서 작업하기',
              body: 'Claude에게 특정 프로젝트나 폴더를 연결하는 곳입니다. 수업 자료를 붙여서 이어서 작업할 때 여기서 범위를 고릅니다.',
              x: 23,
              y: 83,
              width: 35,
              height: 14,
            ...
            },
            {
              label: '4',
              title: '질문 모드',
              body: '일반 질문을 할 때 쓰는 선택입니다. 첫날에는 기본값으로 둡니다.',
              x: 51,
              y: 83,
              placement: 'top',
            },
            {
              label: '5',
              title: '모델 선택',
              body: '답변에 쓸 모델을 고르는 곳입니다. 처음에는 기본값으로 둡니다.',
              x: 78,
              y: 56,
              placement: 'top',
            },
            {
              label: '6',
              title: '음성 입력',
              body: '말로 입력할 때 씁니다. 수업 첫날에는 타이핑이 더 안전합니다.',
              x: 93,
              y: 56,
              placement: 'left',
            },
